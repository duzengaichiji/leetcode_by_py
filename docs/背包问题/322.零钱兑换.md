...
>
> 
![322_dfs_tree](https://github.com/duzengaichiji/leetcode_by_py/blob/master/imgs/322_dfs_tree.png "binaryTree")
> 
...
> 
> 如果两个节点p和q，二者对应的cur值一样，并且p在q的左边，且p的深度小于q，那么q对应的分支将不会被遍历；
>
...
>
> 可以看到，x=5的方案是由x=3的方案[1,2]+[2]得到，即可以说它取决于x=3的最佳方案以及你是否有2元的硬币；
>
